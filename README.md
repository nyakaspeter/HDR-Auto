...
## How to use HDR-Auto
Download the hdr-auto.exe from the releases page or build from source using the instructions below. Run the program and look for the system tray icon to ensure it is running.
