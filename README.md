...
## Why use HDR-Auto?
Leaving HDR on results in washed out colors in Windows. Setting SDR content brightness in Windows settings helps, but doesn't fully resolve the issue because Windows 11 uses a piecewise sRGB gamma, rather the 2.2 gamma used by most content.
